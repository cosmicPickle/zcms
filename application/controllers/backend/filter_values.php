...
class Filter_Values extends CI_Controller {
        ...
        public function edit($id = NULL)
        {
            ...
            $this->interface->form->init('product_filter_values', $rel, $get_data);
        ...
        public function delete($id) 
        {
            ...
            $this->zcms->interface->load_interface('form'); 
            $this->interface->form->init('product_filter_values', NULL, FALSE);

            $this->interface->form->delete(array('id' => $id), base_url('index.php/backend/filter_values/')); 
        }
}
