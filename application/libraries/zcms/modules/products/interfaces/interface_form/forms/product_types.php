...
class Product_Types extends Interface_form{
    
    public function setup($form)
    {
        return $form->add_field('type',array(
                    'type' => 'text',
                ...
                ->add_field('parent_id',array(
                    ...
                    'link_table' => 'product_types',
                    'link_opt_column' => 'id',
                    'link_val_column' => 'type',
                    'opt_val_pairs' => array(
                ...
                ->add_field('image',array(
                    ...
                    'validation' => '',
                    'delete_action' => 'types/delete_img/{#id}/{@file}',
                ))
                ->add_submit(array(
