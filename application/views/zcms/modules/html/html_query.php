<div class="col-md-6  productinfo">
    <div class="tab-content" style="min-height: 0;">
        <div id="home" class="tab-pane fade active in">
            <h4><?php echo $this->translate->t("Запитване") . (($query->get_product()) ? (" for product ". $query->get_product()->title) : NULL); ?></h4>
            ...
            <form action="<?php echo current_url() . (($query->get_product()) ? ("?id=".$query->get_product()->id_) : NULL); ?>" role="form" method="POST">
                ...
                <button type="submit" class="btn btn-default pull-right"><?php echo $this->translate->t("Изпрати"); ?></button>
            </form>
        </div>
    </div>
</div>