...
(2, 2, 'EN', 'Simple News', 'Simple, news, keywords', 'Simple News Description', '<p>Lorem ipsum yada yada</p>');
...
(1, '404 Page not found', '', '', '<p>&nbsp;{content/content_article:category_article,category_article?category=news}</p>', 1, 'EN');
